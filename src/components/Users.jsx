...
const Users = () => {
  ...
  const inactiveUsers = usersList.filter(user => user.isActive === false).length;
    ...
    <div className="w-full max-w-[1150px] mx-auto px-8">
      ...
      <div className="users flex items-center justify-between py-8">
        <div>
          ...
          <p className='bg-[#1ea52b] max-w-[250px] md:text-[1.8rem] xl:text-[2.2rem] text-[#fff] font-bold text-center py-1 mt-1.5 rounded-2xl'>{totalUsers}</p>
        </div>

        <div>
          <p className='uppercase md:text-[0.9rem] xl:text-[1.1rem] font-semibold '>Number of active users</p>
          <p className='bg-[#1ea52b] max-w-[250px] md:text-[1.8rem] xl:text-[2.2rem] text-[#fff] font-bold text-center py-1 mt-1.5 rounded-2xl'>{activeUsers}</p>
        </div>

        <div>
          <p className='uppercase md:text-[0.9rem] xl:text-[1.1rem] font-semibold '>Number of inactive users</p>
          <p className='bg-[#1ea52b] max-w-[250px] md:text-[1.8rem] xl:text-[2.2rem] text-[#fff] font-bold text-center py-1 mt-1.5 rounded-2xl'>{inactiveUsers}</p>
        </div>
      </div>
            ...
            <tbody>
              {filteredUsers.map((user) => (
                <tr key={user.id} className='text-center'>
                  <td className='text-nowrap py-4 px-7 uppercase font-medium'>{user.regDate}</td>
                  <td className='text-nowrap py-4 px-7 uppercase font-medium'>{user.name}</td>
                  <td className='text-nowrap py-4 px-7 uppercase font-medium'>{user.email}</td>
                  <td className='text-nowrap py-4 px-7 uppercase font-medium'>{user.mobile}</td>
                  <td className='text-nowrap py-4 px-7 uppercase font-medium'>{user.status}</td>
                  <td className='text-nowrap py-4 px-7 uppercase font-medium'>{user.country}</td>
                  <td className='text-nowrap py-4 px-7 uppercase font-medium'>{user.region}</td>
